...
| 9 | **Exit** | Simulates the exit behavior of the command-line application. In the browser context, it clears the output panel and displays a "Goodbye!" message. To fully close the demo, navigate away from the page or close the browser tab. |
