---
title: "SQLite Database Integration in Corner Grocer"
sidebarTitle: "Overview"
description: "Corner Grocer uses SQLite for persistent grocery frequency storage across sessions — no server required. Learn the schema, data flow, and design decisions."
---
